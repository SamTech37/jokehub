...
export default function Privacy() {
  return (
    <Body>
      <h1>Privacy Policy for JokeHub</h1>

      <p>
        At JokeHub, accessible from{" "}
        <a href="https://jokehub6969.web.app/">https://jokehub6969.web.app/</a>{" "}
        and <a href="https://jokehub.web.app/">https://jokehub.web.app/</a>, one
        of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by JokeHub and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in JokeHub. This policy is not applicable to any
      ...
      <p>
        ...
        information, including items such as email address. The authentication
        is fully processed by the OAuth provider, Facebook and Google.
      </p>
      ...
      <p>
        JokeHub follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, JokeHub uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertisements and links that appear on JokeHub, which are sent directly
      ...
      <p>
        Note that JokeHub has no access to or control over these cookies that
      ...
      <p>
        JokeHub's Privacy Policy does not apply to other advertisers or
