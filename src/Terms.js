...
export default function Terms() {
  return (
    <Body>
      ...
      <p>Updated at 2021-12-30</p>
      <h1>General Terms</h1>
      <p>
        By accessing and placing an order with JokeHub, you confirm that you are
        in agreement with and bound by the terms of service contained in the
        Terms and Conditions outlined below. These terms apply to the entire
        website and any email or other type of communication between you and
        JokeHub.
        <br />
        <br />
        Under no circumstances shall JokeHub team be liable for any direct,
        ...
        inability to use, the materials on this site, even if JokeHub team or an
        ...
        <br />
        <br />
        JokeHub will not be responsible for any outcome that may occur during
      ...
      <p>
        ...
        are a contract between you and JokeHub ("we," "our," or "us") grants you
      ...
      <ul type="disc">
        ...
        <li>
          ...
          to JokeHub that is responsible for your information under this Privacy
          Policy.
        </li>
        <li>
          <strong>Country: </strong>
          where JokeHub or the owners/founders of JokeHub are based, in this
          case is Taiwan.
        </li>
        <li>
          <strong>Customer: </strong>
          refers to the company, organization or person that signs up to use the
          JokeHub Service to manage the relationships with your consumers or
          service users.
        </li>
        <li>
          <strong>Device: </strong>
          any internet connected device such as a phone, tablet, computer or any
          other device that can be used to visit JokeHub and use the services.
        </li>
        <li>
        ...
        <li>
          ...
          refers to those individuals who are employed by JokeHub or are under
        ...
        <li>
          ...
          refers to the service provided by JokeHub as described in the relative
      ...
      <p>
        ...
        third party's site. We strongly advise You to review the Terms and
      ...
      <p>
        ...
        material and are protected by Taiwan and international copyright,
      ...
      <p>
        ...
        or portion of these Terms and Conditions to be unenforceable, the
        remainder of these Terms and Conditions will continue in full force and
        effect. Any waiver of any provision of these Terms and Conditions will
        ...
        control our Service from our offices in Taiwan. The Service is not
        ...
        our Service from other locations do so on their own initiative and are
        solely responsible for compliance with local laws, if and to the extent
        local laws are applicable. These Terms and Conditions (which include and
